...
public class GamePlay { 
	...
	public HandPoker getBestMadeHand(Player player) {
		//FIXME: DJ this should not return null, it should return back the best made hand in the hashmap
		return null;
	}
	...
	public ArrayList<HandPoker> getBestPossibleHands(Player player) {
		//FIXME: Courtney this should not return null, it should return an array of the best possible hands
		return null;
	}
	...
	public HandPoker GetPlayersHand(Player player) {
		//this should return back the Player's hand from the hashmap
		//should have test case for null hand
			if(BestMadeHand.get(player.getPlayerID())==null) {
				return null;
			}else{
	...
	public boolean isMadeHandBestPossibleHand(Player player) {
		//FIXME: Lisa - If the BestMadeHand is in the BestPossibleHands, return true.  The player has the NUTS!
		if(BestPossibleHands.get(player.getPlayerID()) == BestMadeHand.get(player.getPlayerID())) {
			return true;
		}
		return false;
	}
	...
	protected void SetBestMadeHand(UUID PlayerID, HandPoker HandPoker) {
		//FIXME: Lisa Put the best made hand for a plyer in the map.
	...
	protected void SetBestPossibleHands(UUID PlayerID, ArrayList<HandPoker> BestHands) {
		//FIXME: Courtney Set the best possible hands in the map
	}
